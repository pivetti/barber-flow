    ...
    extend: {
      colors: {
        ...
        brand: {
          ...
          active: "rgb(var(--brand-secondary-rgb) / <alpha-value>)",
          50: "rgb(var(--brand-accent-rgb) / <alpha-value>)",
          100: "rgb(var(--brand-accent-rgb) / <alpha-value>)",
          200: "rgb(var(--brand-accent-rgb) / <alpha-value>)",
          300: "rgb(var(--brand-secondary-rgb) / <alpha-value>)",
          ...
          950: "rgb(var(--brand-primary-rgb) / <alpha-value>)",
        },
        secondary: {
